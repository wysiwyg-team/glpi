...
class Html {
   ...
   **/
   static function header($title, $url = '', $sector = "none", $item = "none", $option = "") {
      ...
      echo Html::link('', $CFG_GLPI["root_doc"]."/front/central.php",
                      ['accesskey' => '1',
                            'title'     => __('Home')]);
      echo "</div><span style='color:white;font-weight:900;font-size:25px;float:center'>Wysiwyg</span>";
   ...
   **/
   static function simpleHeader($title, $links = []) {
      ...
      echo "<a href='".$CFG_GLPI["root_doc"]."/' accesskey='1' title=\"".__s('Home')."\">".
           "<span class='invisible'>Logo</span></a></div><span style='color:white;font-weight:900;font-size:25px;'>Wysiwyg</span>";
   ...
   **/
   static function helpHeader($title, $url = '') {
      ...
      echo "</div><span style='color:white;font-weight:900;font-size:25px;'>Wysiwyg</span>";
