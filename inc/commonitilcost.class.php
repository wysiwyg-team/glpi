...
//            $this->showFormButtons($options);
            ...
            echo "<tr class='tab_bg_1'>";
            echo "<td>" . __('Services') . "</td>";
            echo "<td>";
            echo "<div class='select2-container'><select class='select2-choice' name='services'><option value=''>None</option>";
            $query = "SELECT * FROM custom_cost_category";
...
//            echo "<tr class='tab_bg_1'>";
//            echo "<td>" . __('Produits') . "</td>";
//            echo "<td>";
//            echo "<div class='select2-container'><select class='select2-choice' name='produits'><option value=''>None</option>";
//            $query = "SELECT * FROM custom_produits";
//            $result = $DB->query($query);
//            while ($row = $DB->fetch_array($result)) {
//                echo "<option value='" . $row['id'] . "'>" . $row['produits_name'] . "</option>";
//            };
//            echo "</select></div>";
//            echo "</td>";
//            echo "</tr>";
