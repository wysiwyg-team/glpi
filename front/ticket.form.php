...
if (isset($_POST["add"])) {
    ...
    if ($id = $track->add($_POST)) {
        ...
        $queryInsert = "INSERT INTO custom_tickets_societe (tickets_id, societe_id) VALUES ($id," . $_POST['societe'] . ")";
    ...
    $queryUpdate = "UPDATE custom_tickets_societe SET societe_id = " . $_POST['societe'] . " WHERE tickets_id = " . $_POST['id'] . " ";
    ...
    if ($track->delete($_POST, 1)) {
        ...
        $queryPurge = "DELETE FROM custom_tickets_societe WHERE tickets_id =" . $_POST['id'] . " ";
        $DB->query($queryPurge);
